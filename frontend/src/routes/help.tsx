        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          {[
            [
              ...
              "Download the desktop agent and connect it to your account.",
            ],
            ["Connect your Gemini key", "Bring your own key. Stored locally only."],
            [
              "Import your first jobs",
              "Paste a URL or watch the agent scrape Lever, Greenhouse, Ashby.",
            ],
