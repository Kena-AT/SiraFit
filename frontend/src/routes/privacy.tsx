    ...
    <MarketingShell>
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-8 space-y-5 text-sm text-foreground/90">
          <p>
            SiraFit is built local-first. Sensitive operations like scraping, AI execution, and
            resume rendering happen on your machine.
          </p>
          <h2 className="text-lg font-semibold">What we store in the cloud</h2>
          <p>
            Normalized job projections, application metadata, and resume JSON necessary to power
            your dashboard. No raw HTML is stored beyond a 30–90 day window.
          </p>
          <h2 className="text-lg font-semibold">API keys</h2>
          <p>
            Your Gemini API key is stored locally only. It is never transmitted to SiraFit servers.
          </p>
