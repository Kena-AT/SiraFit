...
function SettingsIndex() {
  ...
  if (error) return <div className="p-4 text-sm text-red-500">Failed to load profile. Make sure the backend is running.</div>;
    ...
    <div className="grid gap-4 lg:grid-cols-2">
      <Panel title="Profile">
        <div className="grid gap-3 p-4">
          <div className="space-y-1.5"><Label>Name</Label><Input defaultValue={`${profile.first_name ?? ""} ${profile.last_name ?? ""}`.trim()} /></div>
