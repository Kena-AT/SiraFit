  ...
  component: () => (
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-4 text-muted-foreground">
        SiraFit is local-first. You bring your own AI key; we store it encrypted at rest and never
        log your requests or responses.
      </p>
      ...
      <ol className="mt-4 list-decimal list-inside space-y-2 text-sm">
        <li>
          Go to <strong>Settings → AI Keys</strong> in the dashboard.
        </li>
        <li>
          Paste your Gemini API key into the <em>Gemini</em> field.
        </li>
        <li>Save. The key is encrypted and stored only on your account.</li>
        <li>
          Run a quick <strong>Analyze</strong> on any job to verify connectivity.
        </li>
      </ol>
    </article>
  ),
