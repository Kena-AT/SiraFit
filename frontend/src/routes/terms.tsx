    ...
    <MarketingShell>
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-8 space-y-5 text-sm text-foreground/90">
          <p>
            By using SiraFit you agree not to automate application submissions, abuse rate limits,
            or use the platform for recruiter-side workflows.
          </p>
          <p>
            SiraFit is provided as-is. Job postings are sourced from third parties; accuracy is
            best-effort.
          </p>
        </div>
      </article>
