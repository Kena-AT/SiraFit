  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <SectionCard title="Contact Information">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Input label="Email" type="email" value={profile.email || ''} onChange={(value) => handleFieldChange('email', value)} maxLength={255} placeholder="john.doe@example.com" />
          <Input label="Phone" value={profile.phone || ''} onChange={(value) => handleFieldChange('phone', value)} maxLength={50} placeholder="+1 (555) 123-4567" />
          <Input label="Location" value={profile.location || ''} onChange={(value) => handleFieldChange('location', value)} maxLength={255} placeholder="San Francisco, CA" />
          <Input label="Website" value={profile.website || ''} onChange={(value) => handleFieldChange('website', value)} maxLength={255} placeholder="https://portfolio.com" />
          <Input label="LinkedIn" value={profile.linkedin || ''} onChange={(value) => handleFieldChange('linkedin', value)} maxLength={255} placeholder="https://linkedin.com/in/johndoe" />
          <Input label="GitHub" value={profile.github || ''} onChange={(value) => handleFieldChange('github', value)} maxLength={255} placeholder="https://github.com/johndoe" />
        </div>
      </SectionCard>
      ...
      <SectionCard title="Work Experience">
        ...
        <button
          onClick={() => handleAddItem('experiences', { title: '', company: '', is_current: false } as Experience)}
