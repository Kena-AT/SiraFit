...
class UserLearningProgress(Base):
    ...
    resource_id = Column(UUID(as_uuid=True), ForeignKey("learning_resources.id", ondelete="CASCADE"), nullable=True)
    project_template_id = Column(UUID(as_uuid=True), ForeignKey("project_templates.id", ondelete="CASCADE"), nullable=True)
